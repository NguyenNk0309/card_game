...
export const CHARACTER_SKILL_CARDS: Record<string, CharacterSkillCard[]> = {
  ...
  "Nyx Calder": [
    ...
    { id: "nc-pilfer", name: "Pilfered Chance", type: "Wit", description: "Steal one common card from a living enemy. Return it when the target's next turn ends.", bonus: 0, effect: "support", target: "enemy", value: 1, supportType: "steal-card", failureEffect: "self-damage", failureValue: 2 }
  ],
  "Bram Coalhand": [
