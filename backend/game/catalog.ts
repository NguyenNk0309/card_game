...
export const HERO_TEMPLATES: Omit<Hero, "id" | "team" | "isYou">[] = [
  ...
  { name: "Sable Fen", title: "The Eye of the Storm", role: "Controller", classId: "oracle", className: "Fate Oracle", passiveName: "Second Sight", passiveText: "The first time Sable is defeated, she immediately revives with half of her maximum HP.", skill: "Favorable Omen", skillText: "Shield allies before a difficult target.", summary: "A fate controller who shields allies, curses enemy rolls, cancels one enemy turn, and can return from defeat once.", strength: "Powerful tempo control and a one-time self-revival.", weakness: "Low HP, no special damage, and severe team backlash.", impact: "Protects the team, changes who gets to act, then bends fate once to survive defeat.", hp: 8, maxHp: 8, speed: 7, color: "#6aa8a5", initials: "SF" },
...
export const CHARACTER_SKILL_CARDS: Record<string, CharacterSkillCard[]> = {
  ...
  "Sable Fen": [
    { id: "sf-favor", name: "Favorable Omen", type: "Spirit", description: "All living allies, including yourself, gain 2 shield. Expires at the end of each target's next turn.", bonus: 0, effect: "support", target: "all-allies", value: 2, supportType: "shield", failureEffect: "self-damage", failureValue: 1 },
