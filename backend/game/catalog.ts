...
export const HERO_TEMPLATES: Omit<Hero, "id" | "team" | "isYou">[] = [
  ...
  { name: "Ione Mire", title: "The Oathkeeper", role: "Support", classId: "support", className: "Tactical Commander", passiveName: "Commanding Voice", passiveText: "Ione gains +1 to every d20.", skill: "Attack Order", skillText: "Boost the team's next attacks.", summary: "A commander who buffs allies and purges enemy cards.", strength: "Reliable rolls and team buffs.", weakness: "No special damage, shield, or healing.", impact: "Improves allies while denying one card.", hp: 9, maxHp: 9, speed: 6, color: "#bd9f76", initials: "IM" },
