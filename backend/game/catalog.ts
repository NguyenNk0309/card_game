...
export const CHARACTER_SKILL_CARDS: Record<string, CharacterSkillCard[]> = {
  "Elara Voss": [
    { id: "ev-aegis", name: "Rallying Aegis", description: "All living allies, including yourself, gain 2 shield (3 with United Front); expires at the end of each target's next turn.", bonus: 0, effect: "guard", target: "all-allies", value: 2, failureEffect: "team-damage", failureValue: 1 },
    { id: "ev-ward", name: "Lantern Ward", description: "One living ally, including yourself, gains 3 shield (4 with United Front); expires at the end of the target's next turn.", bonus: 0, effect: "guard", target: "ally", value: 3, failureEffect: "lose-shield", failureValue: 2 },
  ...
  "Thorne Vale": [
    { id: "tv-mark", name: "Marked Arrow", description: "Deal 4 damage to one living enemy (5 when Deadeye triggers).", bonus: 0, effect: "damage", target: "enemy", value: 4, failureEffect: "self-damage", failureValue: 1 },
    { id: "tv-pierce", name: "Piercing Arrow", description: "Deal 3 damage to one living enemy, ignoring shield (4 when Deadeye triggers).", bonus: 0, effect: "damage", target: "enemy", value: 3, ignoresShield: true, failureEffect: "self-damage", failureValue: 2 },
  ...
  "Mira Ash": [
    { id: "ma-inferno", name: "Inferno", description: "Deal 3 damage to every living enemy (4 with Spreading Flame).", bonus: 0, effect: "aoe", target: "all-enemies", value: 3, failureEffect: "team-damage", failureValue: 1 },
  ...
  "Brother Orren": [
    { id: "bo-prayer", name: "Prayer of Life", description: "One living ally, including yourself, restores 3 HP (4 with Enduring Grace); cannot revive.", bonus: 0, effect: "heal", target: "ally", value: 3, failureEffect: "self-damage", failureValue: 1 },
    { id: "bo-blessing", name: "Shared Blessing", description: "All living allies, including yourself, restore 2 HP (3 with Enduring Grace); cannot revive.", bonus: 0, effect: "heal", target: "all-allies", value: 2, failureEffect: "team-damage", failureValue: 1 },
    { id: "bo-return", name: "Returning Light", description: "Immediately revive one defeated ally with one-third HP; then this card enters the graveyard.", bonus: 0, effect: "support", target: "defeated-ally", value: 1, supportType: "revive", failureEffect: "team-damage", failureValue: 2 }
  ],
  "Nyx Calder": [
  ...
  "Bram Coalhand": [
    { id: "bc-fortress", name: "Living Fortress", description: "One living ally, including yourself, gains 4 shield; expires at the end of the target's second turn.", bonus: 0, effect: "guard", target: "ally", value: 4, failureEffect: "lose-shield", failureValue: 3 },
    { id: "bc-temper", name: "Temper Armor", description: "All living allies, including yourself, gain 3 shield; expires at the end of each target's second turn.", bonus: 0, effect: "guard", target: "all-allies", value: 3, failureEffect: "team-damage", failureValue: 1 },
  ...
  "Kael Rook": [
    { id: "kr-riposte", name: "Riposte", description: "Deal 3 damage to one living enemy (5 with No Guard if the target has no shield).", bonus: 0, effect: "damage", target: "enemy", value: 3, failureEffect: "self-damage", failureValue: 2 },
    { id: "kr-duel", name: "Challenge", description: "Deal 3 damage to one living enemy (5 with No Guard if the target has no shield).", bonus: 0, effect: "damage", target: "enemy", value: 3, failureEffect: "lose-shield", failureValue: 3 },
  ...
  "Ione Mire": [
    ...
    { id: "im-purge", name: "Tactical Purge", description: "Move 1 random card from an enemy hand to their graveyard for 2 phases, then return it to their draw pile; after its third use, this card enters Ione's graveyard.", bonus: 0, effect: "support", target: "enemy", value: 2, supportType: "purge-card", failureEffect: "self-damage", failureValue: 2 }
  ],
  "Dagan Flint": [
