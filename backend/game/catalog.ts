...
export const HERO_TEMPLATES: Omit<Hero, "id" | "team" | "isYou">[] = [
  { name: "Elara Voss", title: "The Undying Lantern", role: "Guardian", classId: "warden", className: "Guardian Warden", passiveName: "Lantern-Forged Guard", passiveText: "Elara's Guard cards grant +1 shield.", skill: "Lantern Phalanx", skillText: "Shield every ally.", summary: "A guardian who shields allies and adjusts turn order.", strength: "Team shields and turn rescue.", weakness: "No special attacks; moderate HP.", impact: "Stabilizes allies for a finisher.", hp: 11, maxHp: 11, speed: 3, color: "#d5b56b", initials: "EV" },
  ...
  { name: "Brother Orren", title: "The Burden Bearer", role: "Healer", classId: "healer", className: "Restoration Cleric", passiveName: "Graceful Restoration", passiveText: "Orren's Heal cards restore +1 HP.", skill: "Graceful Renewal", skillText: "Restore heavy ally HP.", summary: "A healer who restores and revives allies.", strength: "Best healing and only ally revive.", weakness: "No special damage; revive is single-use.", impact: "Reverses one critical defeat.", hp: 10, maxHp: 10, speed: 4, color: "#789bad", initials: "BO" },
  { name: "Nyx Calder", title: "The Blade in Shadow", role: "Assassin", classId: "assassin", className: "Saboteur Assassin", passiveName: "Veilpiercer", passiveText: "Nyx's Attack cards ignore shield.", skill: "Veilpiercing Knife", skillText: "Strike through shield.", summary: "A fast assassin who pierces shield and steals cards.", strength: "Shield bypass and hand disruption.", weakness: "Low HP and severe backlash.", impact: "Punishes shield-heavy enemies.", hp: 8, maxHp: 8, speed: 10, color: "#9a83b7", initials: "NC" },
