...
export const HERO_TEMPLATES: Omit<Hero, "id" | "team" | "isYou">[] = [
  ...
  { name: "Kael Rook", title: "The Challenger", role: "Duelist", classId: "duelist", className: "Disruptive Duelist", passiveName: "No Guard", passiveText: "Kael's attacks deal +2 damage to enemies with no shield.", skill: "Riposte", skillText: "Deal heavy single-target damage.", summary: "A risky duelist who attacks and strips defenses.", strength: "High focused damage and dispel.", weakness: "Reduced damage against shielded enemies.", impact: "Breaks defenses before finishing.", hp: 10, maxHp: 10, speed: 8, color: "#a96161", initials: "KR" },
...
export const CHARACTER_SKILL_CARDS: Record<string, CharacterSkillCard[]> = {
  ...
  "Kael Rook": [
    { id: "kr-riposte", name: "Riposte", description: "Deal 3 damage to one living enemy (5 with No Guard if the target has no shield).", bonus: 0, effect: "damage", target: "enemy", value: 3, failureEffect: "self-damage", failureValue: 2, pityCost: 6 },
    { id: "kr-duel", name: "Challenge", description: "Deal 3 damage to one living enemy (5 with No Guard if the target has no shield).", bonus: 0, effect: "damage", target: "enemy", value: 3, failureEffect: "lose-shield", failureValue: 2, pityCost: 6 },
