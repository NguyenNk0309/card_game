...
export const CHARACTER_SKILL_CARDS: Record<string, CharacterSkillCard[]> = {
  ...
  "Sable Fen": [
    { id: "sf-favor", name: "Favorable Omen", type: "Spirit", description: "All living allies, including yourself, gain +2 to d20 rolls. Expires at the end of each target's next turn.", bonus: 0, effect: "support", target: "all-allies", value: 2, supportType: "dice", failureEffect: "self-damage", failureValue: 1 },
...
const COMMON_ACTION_CARDS: CardWithoutPity[] = [
  ...
  { id: "brace", name: "Brace", type: "Spirit", description: "Gain 3 shield. Expires at the end of your next turn.", bonus: 5, effect: "guard", target: "self", value: 3, unique: false },
