...
export const HERO_TEMPLATES: Omit<Hero, "id" | "team" | "isYou">[] = [
  ...
  { name: "Bram Coalhand", title: "The Red-Coal Bulwark", role: "Tank", classId: "tank", className: "Bulwark Tank", passiveName: "Tempered Steel", passiveText: "Shield from Bram's Guard cards lasts for 2 turns.", skill: "Living Fortress", skillText: "Give one ally heavy shield.", summary: "A durable tank who shields allies and turns defense into offense.", strength: "Highest HP and longest-lasting shields.", weakness: "No special damage, healing, or control.", impact: "Keeps one key ally alive.", hp: 14, maxHp: 14, speed: 1, color: "#c98b58", initials: "BC" },
  ...
  { name: "Kael Rook", title: "The Challenger", role: "Duelist", classId: "duelist", className: "Disruptive Duelist", passiveName: "No Guard", passiveText: "Kael's Attack cards deal +1 damage while he has no shield.", skill: "Riposte", skillText: "Deal heavy single-target damage.", summary: "A risky duelist who attacks and strips defenses.", strength: "Focused damage while unshielded and strong dispel.", weakness: "No Guard is inactive while Kael has shield.", impact: "Breaks defenses before finishing.", hp: 10, maxHp: 10, speed: 8, color: "#a96161", initials: "KR" },
...
export const CHARACTER_SKILL_CARDS: Record<string, CharacterSkillCard[]> = {
  "Elara Voss": [
    { id: "ev-aegis", name: "Rallying Aegis", description: "All living allies, including yourself, gain 2 shield (3 with United Front); expires at the end of each target's next turn.", bonus: 0, effect: "guard", target: "all-allies", value: 2, failureEffect: "team-damage", failureValue: 1, pityCost: 5 },
    { id: "ev-ward", name: "Lantern Ward", description: "One living ally, including yourself, gains 3 shield (4 with United Front); expires at the end of the target's next turn.", bonus: 0, effect: "guard", target: "ally", value: 3, failureEffect: "lose-shield", failureValue: 2, pityCost: 5 },
    { id: "ev-command", name: "Rescue Formation", description: "Move another living ally directly behind Elara in turn order.", bonus: 0, effect: "support", target: "ally", value: 1, supportType: "advance-ally", failureEffect: "self-damage", failureValue: 1, pityCost: 4 }
  ],
  "Thorne Vale": [
    { id: "tv-mark", name: "Marked Arrow", description: "Deal 4 damage to one living enemy (5 when Deadeye triggers).", bonus: 0, effect: "damage", target: "enemy", value: 4, failureEffect: "self-damage", failureValue: 2, pityCost: 6 },
    { id: "tv-pierce", name: "Piercing Arrow", description: "Deal 3 damage to one living enemy, ignoring shield (4 when Deadeye triggers).", bonus: 0, effect: "damage", target: "enemy", value: 3, ignoresShield: true, failureEffect: "self-damage", failureValue: 2, pityCost: 6 },
    { id: "tv-hunt", name: "Hunter's Mark", description: "One living ally, including yourself, gains +2 attack damage; expires at the end of the target's next turn.", bonus: 0, effect: "support", target: "ally", value: 2, supportType: "attack", failureEffect: "enemy-shield", failureValue: 1, pityCost: 5 }
  ],
  "Mira Ash": [
    { id: "ma-inferno", name: "Inferno", description: "Deal 3 damage to every living enemy (4 with Spreading Flame).", bonus: 0, effect: "aoe", target: "all-enemies", value: 3, failureEffect: "team-damage", failureValue: 1, pityCost: 7 },
    { id: "ma-comet", name: "Ash Comet", description: "Deal 2 damage to every living enemy, ignoring shield (3 with Spreading Flame).", bonus: 0, effect: "aoe", target: "all-enemies", value: 2, ignoresShield: true, failureEffect: "self-damage", failureValue: 2, pityCost: 7 },
    { id: "ma-gravity", name: "Gravity Hex", description: "One living enemy gets -2 on their next d20; expires at the end of the target's next turn.", bonus: 0, effect: "support", target: "enemy", value: 2, supportType: "enemy-dice", failureEffect: "enemy-shield", failureValue: 1, pityCost: 5 }
  ],
  "Brother Orren": [
    { id: "bo-prayer", name: "Prayer of Life", description: "One living ally, including yourself, restores 3 HP (4 with Enduring Grace); cannot revive.", bonus: 0, effect: "heal", target: "ally", value: 3, failureEffect: "self-damage", failureValue: 1, pityCost: 5 },
    { id: "bo-blessing", name: "Shared Blessing", description: "All living allies, including yourself, restore 2 HP (3 with Enduring Grace); cannot revive.", bonus: 0, effect: "heal", target: "all-allies", value: 2, failureEffect: "team-damage", failureValue: 1, pityCost: 6 },
    { id: "bo-return", name: "Returning Light", description: "Immediately revive one defeated ally with one-third HP; then this card enters the graveyard.", bonus: 0, effect: "support", target: "defeated-ally", value: 1, supportType: "revive", failureEffect: "team-damage", failureValue: 2, pityCost: 8 }
  ],
  "Nyx Calder": [
    { id: "nc-knife", name: "Quiet Knife", description: "Deal 3 damage to one living enemy, ignoring shield.", bonus: 0, effect: "damage", target: "enemy", value: 3, failureEffect: "self-damage", failureValue: 2, pityCost: 6 },
    { id: "nc-execute", name: "Execute", description: "Deal 4 damage to one living enemy, ignoring shield.", bonus: 0, effect: "damage", target: "enemy", value: 4, ignoresShield: true, failureEffect: "self-damage", failureValue: 3, pityCost: 7 },
    { id: "nc-pilfer", name: "Pilfered Chance", description: "Steal 1 random card from an enemy hand, preferring special cards; return it to their discard pile when Nyx's next turn ends.", bonus: 0, effect: "support", target: "enemy", value: 1, supportType: "steal-card", failureEffect: "enemy-shield", failureValue: 2, pityCost: 7 }
  ],
  "Bram Coalhand": [
    { id: "bc-fortress", name: "Living Fortress", description: "One living ally, including yourself, gains 4 shield; expires at the end of the target's second turn.", bonus: 0, effect: "guard", target: "ally", value: 4, failureEffect: "lose-shield", failureValue: 3, pityCost: 6 },
    { id: "bc-temper", name: "Temper Armor", description: "All living allies, including yourself, gain 3 shield; expires at the end of each target's second turn.", bonus: 0, effect: "guard", target: "all-allies", value: 3, failureEffect: "team-damage", failureValue: 1, pityCost: 7 },
  ...
  "Sable Fen": [
    { id: "sf-favor", name: "Favorable Omen", description: "One living ally, including yourself, plays their next card during their next turn for 0 pity; expires at the end of that turn.", bonus: 0, effect: "support", target: "ally", value: 2, supportType: "zero-pity", failureEffect: "self-damage", failureValue: 2, pityCost: 6 },
    { id: "sf-hex", name: "Dark Omen", description: "One living enemy gets -3 on their next d20; expires at the end of the target's next turn.", bonus: 0, effect: "support", target: "enemy", value: 3, supportType: "enemy-dice", failureEffect: "enemy-shield", failureValue: 1, pityCost: 6 },
    { id: "sf-stolen", name: "Stolen Moment", description: "Cancel one living enemy's next turn. Their effects expire normally when that turn ends.", bonus: 0, effect: "support", target: "enemy", value: 1, supportType: "skip-enemy", failureEffect: "team-damage", failureValue: 2, pityCost: 8 }
  ],
  "Kael Rook": [
    { id: "kr-riposte", name: "Riposte", description: "Deal 3 damage (+1 with No Guard while Kael has no shield).", bonus: 0, effect: "damage", target: "enemy", value: 3, failureEffect: "self-damage", failureValue: 2, pityCost: 5 },
    { id: "kr-duel", name: "Challenge", description: "Deal 3 damage. No Guard: +2 if Kael and the target have no shield; +1 if only Kael has no shield.", bonus: 0, effect: "damage", target: "enemy", value: 3, failureEffect: "lose-shield", failureValue: 2, pityCost: 6 },
    { id: "kr-break", name: "Break Stance", description: "Remove one living enemy's attack and d20 buffs, then destroy up to 3 shield.", bonus: 0, effect: "support", target: "enemy", value: 3, supportType: "dispel-enemy", failureEffect: "enemy-shield", failureValue: 2, pityCost: 6 }
  ],
  "Ione Mire": [
    ...
    { id: "im-purge", name: "Tactical Purge", description: "Move 1 random card from an enemy hand to their graveyard for 2 phases, then return it to their draw pile.", bonus: 0, effect: "support", target: "enemy", value: 2, supportType: "purge-card", failureEffect: "enemy-shield", failureValue: 2, pityCost: 8 }
  ],
  "Dagan Flint": [
    ...
    { id: "df-cleave", name: "Cleave", description: "Deal 4 damage to one living enemy (5 while Dagan is at half HP).", bonus: 0, effect: "damage", target: "enemy", value: 4, failureEffect: "self-damage", failureValue: 2, pityCost: 7 },
