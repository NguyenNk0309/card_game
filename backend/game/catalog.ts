...
export const CHARACTER_SKILL_CARDS: Record<string, CharacterSkillCard[]> = {
  ...
  "Thorne Vale": [
    { id: "tv-mark", name: "Marked Arrow", description: "Deal 4 damage to one living enemy (6 when Deadeye triggers).", bonus: 0, effect: "damage", target: "enemy", value: 4, failureEffect: "self-damage", failureValue: 1 },
    { id: "tv-pierce", name: "Piercing Arrow", description: "Deal 3 damage to one living enemy, ignoring shield (5 when Deadeye triggers).", bonus: 0, effect: "damage", target: "enemy", value: 3, ignoresShield: true, failureEffect: "self-damage", failureValue: 2 },
