...
10. Returning Light immediately revives one defeated ally with one-third HP and then enters Brother Orren's graveyard after its first use. Tactical Purge moves one random card from a living enemy's hand to their graveyard for 2 phases, then returns it to their draw pile; after its third use, Tactical Purge enters Ione Mire's graveyard. Shieldforged Assault converts half of Bram Coalhand's current shield, rounded down, into his next-attack damage bonus; any unused bonus expires at the end of his next turn.
...
12. Favorable Omen gives one living ally, including Sable Fen, a 0-pity card on their next turn. The omen expires if that turn ends without a card being played.
