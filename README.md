...
10. Returning Light immediately revives one defeated ally with one-third HP and then enters Brother Orren's graveyard after its first use. Tactical Purge moves one random card from a living enemy's hand to their graveyard for 2 phases, then returns it to their draw pile. Shieldforged Assault converts half of Bram Coalhand's current shield, rounded down, into his next-attack damage bonus; any unused bonus expires at the end of his next turn.
