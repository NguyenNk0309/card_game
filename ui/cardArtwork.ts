...
const SPECIAL_ARTWORK: Record<string, CardArtwork> = {
  ...
  "lv-verdict": specialScene("lv-verdict", "Liora Venn", "enemy", "Liora pays her own life force to pass Crimson Verdict on one enemy."),
  "lv-remedy": specialScene("lv-remedy", "Liora Venn", "all-allies", "Liora binds every living ally together through Bloodbound Remedy."),
  "lv-communion": specialScene("lv-communion", "Liora Venn", "all-enemies", "Liora releases Red Communion against every living enemy."),
  ...
  "bc-march": specialScene("bc-march", "Bram Coalhand", "enemy", "Bram shatters his entire bulwark into a blade aimed at one enemy."),
