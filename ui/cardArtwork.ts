...
const SPECIAL_ARTWORK: Record<string, CardArtwork> = {
  ...
  "im-command": specialScene("im-command", "Ione Mire", "all-allies", "Ione orders every ally to attack."),
  "im-focus": specialScene("im-focus", "Ione Mire", "all-allies", "Ione focuses every ally for their next roll."),
  "im-purge": specialScene("im-purge", "Ione Mire", "enemy", "Ione removes a card from one enemy hand."),
