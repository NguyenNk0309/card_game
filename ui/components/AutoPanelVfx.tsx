...
export function AutoPanelVfx({ variant }: { variant: AutoPanelVfxVariant }) {
  ...
  const actionOutcome = variant.startsWith("action-outcome-");
  ...
  >
    ...
    <m.span className="auto-panel-vfx-orbit orbit-outer" initial={{ opacity: 0, scale: 0.35, rotate: 0 }} animate={actionOutcome ? { opacity: [0, 0.72, 0], scaleX: [0.55, 1.05, 1] } : { opacity: [0, 0.62, 0], scale: [0.35, 1, 1.12], rotate: world ? 240 : 145 }} transition={{ duration: world ? 2.8 : 2.2, times: [0, 0.28, 1], ease: "linear" }}/>
    <m.span className="auto-panel-vfx-orbit orbit-inner" initial={{ opacity: 0, scale: 0.2, rotate: 120 }} animate={actionOutcome ? { opacity: [0, 0.58, 0], scaleX: [0.5, 1, 0.9], rotate: 90 } : { opacity: [0, 0.55, 0], scale: [0.2, 1, 1.16], rotate: world ? 0 : -100 }} transition={{ duration: world ? 2.4 : 1.8, times: [0, 0.34, 1], ease: "linear" }}/>
