      ...
      <aside className="character-panel">
        ...
        {shownHero ? <div className="character-review-layout">
          <section className="character-info-column">
            ...
            <div className="character-profile"><div className="passive-callout"><Crown size={18}/><div><span>PASSIVE · <b className="passive-name-highlight">{shownHero.passiveName}</b></span><strong>{shownHero.passiveText}</strong></div></div><div className="character-impact-grid"><div className="character-trait strength"><span>Strength</span><strong>{shownHero.strength}</strong></div><div className="character-trait weakness"><span>Weakness</span><strong>{shownHero.weakness}</strong></div></div></div>
