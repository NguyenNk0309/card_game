...
export default function GameApp() {
  ...
  const usePityRoll = () => {
    if (!game || !activePlayer || activePlayer.id !== sessionId || !activeCard || runComplete || status !== "connected" || rolling || (activeState?.hp ?? 0) <= 0 || (activeState?.pityPoints ?? 0) < activePityCost) return;
