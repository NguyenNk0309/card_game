  ...
  return <div className="guide-update-backdrop" onClick={onClose}>
    <section className="guide-update-panel" onClick={(event) => event.stopPropagation()}>
      ...
      <div className="guide-update-grid">
        ...
        <article><strong>4 · Play, discard, or skip</strong><p>Playing a selected card rolls against the current d20 target and sends that card through its normal cycle. Manual Discard also ends the turn. Skip and timeout preserve the exact hand and every card zone.</p></article>
