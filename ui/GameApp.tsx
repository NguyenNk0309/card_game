...
export default function GameApp() {
  ...
  const activeAutoPanel = manualPanelOpen ? null : showOutcome ? "outcome" : showTurnSummary ? "summary" : showLifeEvent ? "life" : showWorldEvent ? "world" : null;
  ...
  const closeModal = () => {
    ...
    if (showLifeEvent && activeLifeEvent) return setDismissedLifeEventIds((current) => [...current, activeLifeEvent.id]);
