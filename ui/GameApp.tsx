...
export default function GameApp() {
  ...
  const showOutcome = Boolean(isLocalCardOutcome && outcomeKey !== dismissedOutcomeKey);
  const showTurnSummary = Boolean(outcome?.actorName && !isLocalCardOutcome && !isLocalDiscardOutcome && outcomeKey !== dismissedSummaryKey);
