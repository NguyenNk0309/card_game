...
export default function GameApp() {
  ...
  useEffect(() => {
    if (!queuedWorldEvent || !isLocalActiveTurn || worldEventBlocking || !queuedPresentation) return;
    setPresentationQueue((current) => current.filter((item) => item.id !== queuedPresentation.id));
  }, [queuedWorldEvent, queuedPresentation, isLocalActiveTurn, worldEventBlocking]);
  useEffect(() => {
