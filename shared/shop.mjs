...
export const SHOP_CATALOG = Object.freeze([
  ...
  { id: 'control-cards', category: 'external', name: 'Control Cards', description: 'One living enemy discards one random card, then refills their hand to 4 if it is below 4.', basePriceUnits: 8, repeatIncreaseUnits: 0, purchaseLimit: 1, card: externalCard({ name: 'Control Cards', description: 'One living enemy discards one random card, then refills their hand to 4 if it is below 4.', effect: 'support', supportType: 'discard-random-card', target: 'enemy', value: 1 }) },
